...
const host = process.env.ROBOT_IP; //process.argv[2];
const fversion = process.env.FIRMWARE || 2; //process.argv[3];

if (host === "") {
  console.log('Define Robot IP Config Variable!');
  process.exit();
}
var requestOptions = {
  'method': 'POST',
...
if (fversion === '1') {
  ...
  console.log('This step will continue in 10 seconds...');
  //process.stdin.setRawMode(true);
  //process.stdin.resume();
  //process.stdin.on('data', checkV2);
  setTimeout(checkV2, 10000);
}
